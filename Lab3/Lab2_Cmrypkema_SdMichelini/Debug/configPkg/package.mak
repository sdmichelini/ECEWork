...
ti.targets.arm.elf.M3.rootDir ?= C:/ti/ccsv5/tools/compiler/arm_5.0.4
...
app.xem3: package/cfg/app_pem3.oem3 
	...
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/app_pem3.oem3   package/cfg/app_pem3.xdl --silicon_version=7M3 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
